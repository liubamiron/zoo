...
import {fetchNewsById, updateNewsData} from "../../utils/apiCalls.js";
...
const NewsEdit = () => {
    ...
    return (
        <div>
            Edit news : <h5 style={{color: 'green'}}>{titleRO}</h5>
            ...
            <Form onSubmit={handleNewsSubmit}>
                ...
                <Row className={'mt-4'}>
                    <Col>
                        <img src={`${import.meta.env.VITE_URL}/${img1}`}/>
                    </Col>
                    <Col>
                        <img src={`${import.meta.env.VITE_URL}/${img2}`}/>
                    </Col>
                </Row>
                <br/>
